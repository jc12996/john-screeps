    ...
    public static getBodyPartsForArchetype(archetype: string, spawn: any, commandLevel: number = 1, hauling:boolean = false): Array<BodyPartConstant> | null {
        ...
        switch(archetype) {
            ...
            case 'miner':
                ...
                else if(hauling && commandLevel >= 7 && energyAvailable >= 2550) {
                ...
                else if(hauling && commandLevel >= 6 && energyAvailable >= 1100) {
            ...
            case 'upgrader':
                if(commandLevel >= 8 && energyAvailable >= 200) {
                    partsPattern = [MOVE,CARRY,WORK];
                    break;
                }
                else if(commandLevel >= 6 && energyAvailable >= 2300) {
                    for (let i = 0; i < 2; i++) {
                        partsPattern.push(MOVE);
                    }
                    for (let i = 0; i < 20; i++) {
